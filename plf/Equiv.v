...
Proof.
  ...
  - (* <- *)
    apply E_IfTrue. simpl. reflexivity. assumption.  Qed.
...
Proof.
  ...
  -
    intros H.
    pose proof (WHILE_true_nonterm b c st st').
    apply H0 in Hb.
    apply Hb in H.
    destruct H.
  -
    intros H.
    pose proof (WHILE_true_nonterm true SKIP st st').
    assert (bequiv true BTrue).
    unfold bequiv.
    simpl.
    reflexivity.
    apply H0 in H1.
